...
sherlock <- readLines("C:/Users/Nano/Desktop/R-Repo/Datasets/sherlock.txt")

save(sherlock, file = "C:/Users/Nano/Desktop/R-Repo/Datasets/sherlock.rda") #dosyayı dizine kaydetme.
rm(sherlock)
